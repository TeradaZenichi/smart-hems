...
# Layout: time (0-7), load 8, pv 9, bess_soc 10, ev_soc 11, ev_ctrl 12,
# tariff 13, weather (14-16), tar_pct 17, pv_ema 18, t_since 19,
# t_until_dep 20, t_until_arr 21, lags (22-27), tariff window, context.
OBS_BESS_SOC     = 10
OBS_EV_SOC       = 11
OBS_EV_CTRL      = 12
OBS_TAR_PCT      = 17
...
class AnticipatoryShapingWrapper:
    ...
    def __init__(self, env, params, gamma: float, omega: float,
        ...
        self._target_soc   = float(ev["soc_min"])         # shortfall-penalty target while connected
        self._ecrit        = float(ev["soc_critical"])    # FC kicks in below this
        self._p_fc         = float(ev["fast_price"])      # EUR/kWh for FC
